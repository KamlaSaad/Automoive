...
class SideNivigation extends StatefulWidget {
  String title;
  SideNivigation(this.title);
  @override
  _SideNivigationState createState() => _SideNivigationState();
}

class _SideNivigationState extends State<SideNivigation> {
  @override
  Widget build(BuildContext context) {
    ...
    return AnimatedPositioned(
        ...
        right:
            checkLang(context) ? (opened ? 0 : width) : (opened ? 0 : -width),
